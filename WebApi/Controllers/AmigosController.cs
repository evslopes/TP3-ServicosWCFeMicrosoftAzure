...
namespace WebApi.Controllers
{
    ...
    public class AmigosController : ControllerBase
    {
        ...
        public async Task<IActionResult> PutAmigo(int id, Amigo amigo)
        {
            ...
            try
            {
                await _context.Database.ExecuteSqlInterpolatedAsync(
                    $"exec AlterarAmigo {id}, {amigo.Nome}, {amigo.Sobrenome}, {amigo.Telefone}, {amigo.DataDeAniversario}");
            }
        ...
        public async Task<ActionResult<Amigo>> PostAmigo(Amigo amigo)
        {
              ...
              await _context.Database.ExecuteSqlInterpolatedAsync(
              $"exec AdicionarAmigo {amigo.Nome}, {amigo.Sobrenome}, {amigo.Telefone}, {amigo.DataDeAniversario}");
